...
(function ($) {
  ...
  acf.add_action('ready append', function (element) {
    acf.get_fields({
      ...
      var context = $(this);
      var unitsInput = $(this).find('input[type=hidden].units');

      var resetDimensionIndicatorClasses = function resetDimensionIndicatorClasses(indicator) {
        $(indicator).removeClass('top').removeClass('left').removeClass('bottom').removeClass('right');
      };
      ...
      var dimensionIndicator = $(this).find('.dimension-indicator');
      $(this).find('[data-direction]').on('blur', function () {
        resetDimensionIndicatorClasses(dimensionIndicator);
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/fields"], () => (__webpack_require__("./resources/css/fields.scss")))
